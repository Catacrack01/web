...
---------------------------------------------------*/	
	...
	function ContactMap() {	
		...
		if( jQuery('#map_canvas').length > 0 ){					
			var latlng = new google.maps.LatLng(41.40052303549034, 2.182361225904884);
			var settings = {
				zoom: 15,
				disableDefaultUI: true,
				center: new google.maps.LatLng(41.40052303549034, 2.182361225904884),
			...
			const companyMarker = new google.maps.marker.AdvancedMarkerElement({
				...
				map: map,
				title: "Our Office",
				content: document.createElement("img") // Puedes usar un elemento personalizado
			});
